...
function updateLocation() {
  LocationHelper.findLocation((location) => {
    ...
    latitudeElement.value = location.latitude;
    longitudeElement.value = location.longitude;
    ...
    discoveryMapImg.parentNode.removeChild(discoveryMapImg);

    discoveryMapSpan.parentNode.removeChild(discoveryMapSpan);
  });
}
